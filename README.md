...
- Updated every repository to dotnet 8.0
- Every nuget package updated
- Samples removed
- Reorganized project
...
* Install Git
* Clone this repo
* Run `dotnet run --project build` in the root of the project youre currently building.
...
Please use the [issue tracker](https://github.com/3DHistech/IdentityServer4/issues) for that. We only support the latest version for free. For older versions, you can get a commercial support agreement with us.
